...
namespace kutuphane
{
    public partial class uyelist : Form
    {
        ...
        {
            baglanti.Open();
            OleDbCommand komut = new OleDbCommand("update uyeler set adsoyad='"+adsoyadBox.Text+"',yas='"+yasBox.Text+"',cinsiyet='"+cinsiyetBox.Text+"',telefon='"+telefonBox.Text+"',eposta='"+adresBox.Text+"',adres='"+epostaBox.Text+"',okudugu_kitap='"+okitapBox.Text+"' where tc='"+tcBox.Text+"'", baglanti);
